...
// export const DataForm = ({ integrationType, credentials, setLoading, setError, loadedData, setLoadedData }) => {
//   const [expanded, setExpanded] = useState(false);
//   const [loading, setLocalLoading] = useState(false); // Add local loading state
...
//     }
//     setLoading(true);
//     setLocalLoading(true); // Update local loading state
//     setError(null);
//     console.log('Sending credentials:', credentials);
//     try {
//       const response = await axios.post(
...
//     } finally {
//       setLoading(false);
//       setLocalLoading(false); // Update local loading state
//     }
//   };
...
//           fullWidth
//           sx={{ mb: 2 }}
//           disabled={!credentials || loading} // Now loading is defined
//         >
